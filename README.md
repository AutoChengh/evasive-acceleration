...
- [Notes on Yaw Rate Input](#notes-on-yaw-rate-input)
- [Applicability to Vulnerable Road Users](#applicability-to-vulnerable-road-users)
- [Usage](#usage)
...
- [Recommended Usage by Scenario](#recommended-usage-by-scenario)
